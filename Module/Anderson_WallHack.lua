...
if not getgenv().Ander or getgenv().Ander.WallHack then return end
...
local Environment = getgenv().Ander.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().Ander.WallHack.Functions = nil
	getgenv().Ander.WallHack = nil
