...
if not getgenv().Ander or getgenv().Ander.Aimbot then return end
...
local Environment = getgenv().Ander.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().Ander.Aimbot.Functions = nil
	getgenv().Ander.Aimbot = nil
