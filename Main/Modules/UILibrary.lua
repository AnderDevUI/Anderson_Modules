...
local library = utility.table({theme = table.clone(themes.Ander), folder = "Ander V2", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Ander"}
...
function library:Load(options)
	...
	local theme = options.theme and options.theme or "Ander"
